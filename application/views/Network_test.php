                        ...
                        <div class="col-sm-12 col-md-12">
                          ...
                          <fieldset>
                            ...
                            <div class="custom-control custom-radio mb-1">
                              ...
                              <label class="custom-control-label" for="formsRadioChecked">digital modulation</label>
                            </div>
                            <div class="custom-control custom-radio mb-1">
                              <input type="radio" id="formsRadioDisabled" name="formsRadioDisabled" class="custom-control-input" >
                              <label class="custom-control-label" for="formsRadioDisabled">multiplexing</label>
                            </div>
                            <div class="custom-control custom-radio mb-1">
                              <input type="radio" id="formsRadioDisabledChecked" name="formsRadioDisabledChecked" class="custom-control-input">
                              <label class="custom-control-label" for="formsRadioDisabledChecked">phase modulation</label>
                            </div>
                          </fieldset>
                          </form>
                        </div>
    ...
    <div class="container about-container wow fadeInUp">
      <div class="row">
        ...
        <div class="col-lg-6 about-img">
          <img src="<?php echo base_url('assets/img/about-img.jpg');?>"alt="gh">
        </div>

        <div class="col-md-6 about-content">
          <h2 class="about-title">We provide great services and ideas</h2>
          <p class="about-text">
        This job portal creates an opportunity for both job seekers and organizations to embrace an easy employment process. Job seekers can register for free on this job portal and they can receive different job posting and updates that is related to their skills. This helps to save time and help streamline the right candidate for a particular job.   </p>
          <p class="about-text">

Our job portal can be used by both organization to post job openings and job seekers to find the job of their choice. Our job portal creates a platform for people seeking for job opportunities as well as corporations seeking best candidates for job openings, to come together.
 </p>
          <p class="about-text">
          This Web portal reduces the communication gap between jobseekers and employers.
Our system is capable of managing all stages of E-Recruitment Process.
